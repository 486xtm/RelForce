...
const LinkButton = ({linkname, title, title1, footer, width}) => {
  ...
  return (
    <div
      ...
      className={`orbitron block mb-2 text-lg font-medium text-left text-primary-dark dark:text-ternary-light hover:text-secondary-dark dark:hover:text-secondary-light ${footer === "1" ? "" : "sm:mx-4 sm:py-2"}`}
      aria-label="Projects"
    >
        <Link href={linkname}>
